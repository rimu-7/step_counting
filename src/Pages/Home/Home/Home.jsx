...
function Home() {
  ...
  return (
    <div className="">
      <div className="">
        <button
          className="absolute top-4 right-4 border-none bg-transparent cursor-pointer text-4xl text-inherit hover:text-blue-900"
          onClick={() => setIsOpen(!isOpen)}
        >
          &times;
        </button>
        {isOpen && (
          <div className="h-screen   text-center p-10 items-center flex justify-center  text-xl">
            <div className=" w-[600px] bg-neutral-200 rounded-lg px-5 py-5 my-[100px] mx-auto ">
